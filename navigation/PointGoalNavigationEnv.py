...
class PointGoalNavigation:
    ...
    def __init__(self, **kwargs):
        self.__dict__.update(dict(
            ...
            laser_range = 1.5, num_beams = 180, laser_noise = 0.01, velocity_max=1, omega_max=1, env_type=4, reward_type="sparse"))
...
#-----------------------------------------------------------------------------------------------------------------------------------------------#
    ...
    def reset(self):
        ...
        # outer walls
        wall_top      = self.world.CreateStaticBody(position=( 0, 3), shapes=b2PolygonShape(box=(6,0.05)))
        wall_bottom   = self.world.CreateStaticBody(position=( 0,-3), shapes=b2PolygonShape(box=(6,0.05)))
        wall_right    = self.world.CreateStaticBody(position=( 6, 0), shapes=b2PolygonShape(box=(0.05,6)))
        wall_left     = self.world.CreateStaticBody(position=(-6, 0), shapes=b2PolygonShape(box=(0.05,6)))
