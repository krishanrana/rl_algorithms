...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--episode-num", type=int, default=2000, help="total episode num"
    )
    parser.add_argument(
...
def main():
    ...
    # env initialization
    env_name = "PointGoalNavigation-v0"
    max_ep_steps = 500
    HYPERS = dict(
    ...
    env, max_episode_steps = env_utils.set_env(env, max_ep_steps)
